...
export class SendForgotPasswordEmail implements EmailInterface {
    ...
    async SendEmailVerification( email: string, verification: string): Promise<any> {
        ...
        const transporter = nodeMailer.createTransport({
            ...
            auth: {
                ...
                pass: process.env.ACCOUN_PASSWORD 
            },
            tls: {
        ...
        const sendVerificationEmail = async (
            ...
            const mailOptions = {
                from: process.env.EMAIL_ACCOUNT, // Will set this via env variables later
                to: toEmail,
